...
@section('content')
    ...
    <div class="page-header">
        <div>
            <h1 class="page-title">Trip List</h1>
        </div>
        <div class="ms-auto pageheader-btn">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0);">Table</a></li>
                <li class="breadcrumb-item active" aria-current="page">Trip Manage</li>
            </ol>
        </div>
    </div>
    {{-- PAGE-HEADER --}}
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered text-nowrap border-bottom w-100" id="datatable">
                            ...
                            <tr>
                                ...
                                <th class="wd-15p border-bottom-0">Traveler</th>
                                ...
                                <th class="wd-15p border-bottom-0">Available Weight</th>
